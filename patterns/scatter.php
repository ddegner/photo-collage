...
<div class="wp-block-photo-collage-container" style="height: 600px; min-height: 200px;">
    <!-- wp:photo-collage/image {"width":"40%","marginLeft":"10%","rotation":-5,"zIndex":1} /-->
    <!-- wp:photo-collage/image {"width":"40%","marginLeft":"10%","marginTop":"-15%","rotation":5,"zIndex":2} /-->
    <!-- wp:photo-collage/image {"width":"35%","marginLeft":"30%","marginTop":"-10%","rotation":0,"zIndex":3} /-->
</div>
